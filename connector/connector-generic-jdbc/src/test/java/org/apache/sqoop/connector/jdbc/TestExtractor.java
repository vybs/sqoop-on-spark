...
public class TestExtractor {
  ...
  public void setUp() {
    executor = new GenericJdbcExecutor(JdbcTestConstants.LINK_CONFIG);
  ...
  public void testQuery() throws Exception {
    ...
    partition.setCondition("-50.0 <= DCOL AND DCOL < -16.6666666666666665");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);

    partition = new GenericJdbcPartition();
    partition.setCondition("-16.6666666666666665 <= DCOL AND DCOL < 16.666666666666667");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);

    partition = new GenericJdbcPartition();
    partition.setCondition("16.666666666666667 <= DCOL AND DCOL <= 50.0");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);
  }
  ...
  public void testSubquery() throws Exception {
    ...
    partition = new GenericJdbcPartition();
    partition.setCondition("-50 <= ICOL AND ICOL < -16");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);

    partition = new GenericJdbcPartition();
    partition.setCondition("-16 <= ICOL AND ICOL < 17");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);

    partition = new GenericJdbcPartition();
    partition.setCondition("17 <= ICOL AND ICOL < 50");
    extractor.extract(extractorContext, linkConfig, jobConfig, partition);
  }
