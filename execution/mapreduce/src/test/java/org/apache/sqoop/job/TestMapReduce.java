...
import org.apache.sqoop.job.mr.SqoopOutputFormat;
...
public class TestMapReduce {
  ...
  public void testSqoopMapper() throws Exception {
    ...
    MRConfigurationUtils.setConnectorSchema(Direction.FROM, job, org.apache.sqoop.job.util.MRJobTestUtil.getTestSchema());
    MRConfigurationUtils.setConnectorSchema(Direction.TO, job, org.apache.sqoop.job.util.MRJobTestUtil.getTestSchema());
  ...
  public static class DummyOutputFormat extends OutputFormat<Text, NullWritable> {
    @Override
    ...
    public static class DummyRecordWriter extends RecordWriter<Text, NullWritable> {
