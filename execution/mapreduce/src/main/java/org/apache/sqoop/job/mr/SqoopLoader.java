...
public class SqoopLoader {

  public static final Logger LOG =
    Logger.getLogger(SqoopLoader.class);
  ...
  SqoopLoader(JobContext jobctx, String loaderName, IntermediateDataFormat<?> toDataFormat, Matcher matcher) {
    context = jobctx;
  ...
  public SqoopLoader(JobContext jobctx) {
    context = jobctx;
 ...
 // Loader pulls data( consumes / reads) from the Record writer belonging to the ouputformat
  private class SqoopDataReader extends DataReader {
  ...
  private class ConsumerThread implements Runnable {
    ...
    public void run() {
      ...
      try {
        DataReader reader = new SqoopDataReader();
