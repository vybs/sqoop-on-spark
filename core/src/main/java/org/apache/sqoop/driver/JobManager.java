...
public class JobManager implements Reconfigurable {
  ...
  public JobRequest createJobRequest(long jobId, MSubmission submission) {
    // get job
    ...
    System.out.println("FROM schema connector" + getSchemaForConnector(jobRequest, Direction.FROM));
    
    System.out.println("TO schenam connector" + getSchemaForConnector(jobRequest, Direction.TO));
    ...
    System.out.println("Using entities: " + jobRequest.getFrom() + ", " + jobRequest.getTo());
    
    System.out.println("FROM schema connector:" + jobRequest.getJobSubmission().getFromSchema());
    
    System.out.println("TO schema connector:" + jobRequest.getJobSubmission().getToSchema());
    return jobRequest;
  }
  ...
  public MSubmission createJobSubmission(HttpEventContext ctx, long jobId) {
